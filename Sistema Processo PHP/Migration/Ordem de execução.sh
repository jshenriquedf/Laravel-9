...
php artisan make:migration create_table_perfil --create=perfil --path=database/migrations/admin
...
php artisan migrate --path=/database/migrations/admin/2022_03_24_000000_create_table_organizacao.php
php artisan migrate --path=/database/migrations/admin/2022_03_24_000000_create_table_perfil.php
